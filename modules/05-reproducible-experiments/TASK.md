# 05 · Experiments you can trust

> **Not open yet.** This is a placeholder so you can see where the track goes. It opens when
> the cohort reaches it — phase: *PyTorch and experiments*.

---

## What it will ask you to build

A config file, a seeded run directory, a metrics.json, a results table and one ablation.

Along the way: configs, run directories, ablations, reading your own results.
